...
+function (a) {
    ...
    if (false)throw new Error("Bootstrap's JavaScript requires jQuery version 1.9.1 or higher")
}(jQuery), +function () {
    "use strict";
    function a(a, b) {
...

    {
        var c = function (a, b, c) {
            ...
            var c = "alert", f = "4.0.0", g = "bs.alert", h = "." + g, i = ".data-api", j = a.fn[c], k = 150, l = {DISMISS: '[data-dismiss="alert"]'}, m = {
                CLOSE: "close" + h,
                CLOSED: "closed" + h,
            ...
            var c = "dropdown", f = "4.0.0", g = "bs.dropdown", h = "." + g, i = ".data-api", j = a.fn[c], k = {
                ...
                return d(c, [{
                    ...
                    key: "_clearMenus", value: function (b) {
                        if (!b || 3 !== b.which) {
                            var d = a(m.BACKDROP)[0];
                            d && d.parentNode.removeChild(d);
                            for (var e = a.makeArray(a(m.DATA_TOGGLE)), f = 0; f < e.length; f++) {
                                var g = c._getParentFromElement(e[f]), h = {relatedTarget: e[f]};
                    ...
                    key: "_dataApiKeydownHandler", value: function (b) {
            ...
            var c = "modal", f = "4.0.0", g = "bs.modal", h = "." + g, i = ".data-api", j = a.fn[c], k = 300, l = 150, m = {
                ...
                return d(i, [{
                    ...
                    key: "_showElement", value: function (b) {
                        ...
                        var f = a.Event(o.SHOWN, {relatedTarget: b}), g = function () {
            ...
            var c = "tab", f = "4.0.0", g = "bs.tab", h = "." + g, i = ".data-api", j = a.fn[c], k = 150, l = {
                ...
                return d(c, [{
                    ...
                    key: "_transitionComplete", value: function (b, c, d, f) {
                        if (c) {
            ...
            var c = "tooltip", f = "4.0.0", g = "bs.tooltip", h = "." + g, i = a.fn[c], j = 150, k = "bs-tether", l = {
                ...
                return d(i, [{
                    ...
                    key: "_removeTetherClasses", value: function (a, b) {
        ...
        !function (e) {
            var g = "popover", h = "4.0.0", i = "bs.popover", j = "." + i, k = e.fn[g], l = e.extend({}, f.Default, {
            ...
            }), m = e.extend({}, f.DefaultType, {content: "(string|function)"}), n = {
                FADE: "fade",
                IN: "in"
            }, o = {
                TITLE: ".popover-title",
                ...
                return a(k, f), d(k, [{
                    ...
                    key: "_jQueryInterface", value: function (a) {
                        return this.each(function () {
