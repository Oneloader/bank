<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view2/bank\_sales_man.html";i:1541390497;s:44:"./application/admin/view2/public\layout.html";i:1539765626;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form method="post" class="form-horizontal" id="branch_form">
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" id="name" placeholder="请输入销售姓名" class="input-txt" name="name" value="<?php echo $info['name']; ?>">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" id="phone" placeholder="请输入手机号码" class="input-txt" name="phone" value="<?php echo $info['phone']; ?>">
                ...
                <dd class="opt">
                    <div>
                        <select name="branch_id" id="branch_id" class="input-txt class-select valid">
                            ...
                            <?php if(is_array($branches) || $branches instanceof \think\Collection || $branches instanceof \think\Paginator): $i = 0; $__LIST__ = $branches;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo $key; ?>" <?php if($info['branch_id'] == $key): ?>selected<?php endif; ?> ><?php echo $v; ?></option>
            ...
            <!--<dl class="row">
                ...
                <dd class="opt">
                    ...
                    <input type="radio" value="1" name="status" <?php if($info['status'] == '1'): ?>checked<?php endif; ?> />&nbsp;显示
                </dd>
            </dl>-->
    ...
    $(function(){
        ...
        $("#branch_form").validate({
            ...
            submitHandler: function(form){   //表单提交句柄,为一回调函数，带一个参数：form
                ...
                $.ajax({
                    url:"<?php echo U('Admin/Bank/addEditSalesMan'); ?>",
                    type:'post',
                    dataType:'json',
