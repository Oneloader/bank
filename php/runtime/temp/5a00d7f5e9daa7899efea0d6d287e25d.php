<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:51:"./application/admin/view2/public\dispatch_jump.html";i:1539138094;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8">
...
.tranjump{width: 100%;height: 100%;position: absolute;top: 0px;left: 0px;}
...
.recigle .copyright{color: #3c8dbc;}
	...
	<body class="tranjump">
	<img src="__PUBLIC__/images/tac.jpg" alt="" style="position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;">
		<div class="rectangle_box">
			<div class="borderopely">
				...
				<div class="tipbox" style="">
					...
					<div class="ma-to-10">
						<a href="<?php echo url('Admin/Index/index'); ?>" target="_parent" class="waittim ht-colblue">管理员后台</a>
					</div>
				</div>
				<!--修改成功-e-->
				<?php }else{?>
