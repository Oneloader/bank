<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view2/index\code_exchange.html";i:1542189744;s:44:"./application/admin/view2/public\layout.html";i:1542249927;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
            ...
            <div class="hDivBox">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="center" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: center; width: 150px;" class="">封面图片</div>
                        </th>
                        <th align="center" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: center; width: 150px;" class="">活动访问地址</div>
                        </th>
                            ...
                            <tr>
                                ...
                                <td align="center" class="">
                                    <div style="text-align: center; width: 150px;">
                                        <img width="100" src="<?php echo $list['img']; ?>" alt="<?php echo $list['name']; ?>" />
                                    </div>
                                </td>

                                <td align="center" class="">
                                    <div style="text-align: center; width: 150px;"><?php echo $list['url']; ?></div>
                                </td>
    ...
    <script>
        ...
        function addBank(id){
            var url = "<?php echo U('Admin/Index/addEditSalesExchange'); ?>?id="+id+'&type='+1;
            layer.open({
                type: 2,
                title: '添加/编辑活动',
                shadeClose: false,
