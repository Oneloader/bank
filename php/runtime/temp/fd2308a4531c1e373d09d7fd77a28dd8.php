<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view2/index\code_exchange.html";i:1539855358;s:44:"./application/admin/view2/public\layout.html";i:1539765626;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <div class="hDivBox">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="center" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: center; width: 350px;" class="">活动访问地址</div>
                        </th>
                ...
                <table>
                    ...
                    <?php if(!(empty($lists) || (($lists instanceof \think\Collection || $lists instanceof \think\Paginator ) && $lists->isEmpty()))): if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td align="center" class="">
                                    <div style="text-align: center; width: 350px;"><?php echo $list['url']; ?></div>
                                </td>
