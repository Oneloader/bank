<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"./application/admin/view2/bank\_change_level.html";i:1539138094;s:44:"./application/admin/view2/public\layout.html";i:1539765626;}*/ ?>
<!doctype html>
<html>
<head>
...
<div>
    ...
    <form method="post" class="form-horizontal" id="branch_form">
        <div class="ncap-form-default">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="name"><em>*</em>兑换档次名称：</label>
                </dt>
                <dd class="opt">
                    <input type="text" id="name" placeholder="请输入名称" class="input-txt" name="name" value="<?php echo $info['name']; ?>">
    ...
    $(function(){
        ...
        $("#branch_form").validate({
            ...
            submitHandler: function(form){   //表单提交句柄,为一回调函数，带一个参数：form
                $.ajax({
                    url:"<?php echo U('Admin/Bank/addEditChangeLevel'); ?>",
                    type:'post',
                    dataType:'json',
