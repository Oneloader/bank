<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:37:"./template/bank/sales\goods_info.html";i:1540438108;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div style="height:100%;padding: 20px 0 20px 0;background-color:<?php echo $data['back_color']; ?>">
    <div class="shop_info_box">
        <p><?php echo $info['goods_content']; ?></p>
    </div>
    <div class="button_dui">
        <a href="<?php echo $info['url']; ?>" class="btn_orange">立即兑换</a>
    </div>
</div>
