<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"./application/admin/view2/index\authority_list.html";i:1539138094;s:44:"./application/admin/view2/public\layout.html";i:1542249927;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page" style="margin-top: -50px;">
                            ...
                            <tr>
                                ...
                                <td align="center" class="">
                                    <div style="text-align: center; width: 180px;">
                                        <?php if($list["is_leader"] == 1): ?>
                                            <span class="yes" onClick="changeTableVal('activity_auth','id','<?php echo $list['id']; ?>','is_leader',this)"><i class="fa fa-check-circle"></i>是</span>
                                            <?php else: ?>
                                            <span class="no" onClick="changeTableVal('activity_auth','id','<?php echo $list['id']; ?>','is_leader',this)"><i class="fa fa-ban"></i>否</span>
                                        <?php endif; ?>
                                    </div>
                                </td>
                                <td align="center">
    ...
    <script>
        function addAuth(){
            ...
            var url = "<?php echo U('Admin/Index/addEditAuth'); ?>?aid="+aid;
            layer.open({
                type: 2,
                title: '加入销售经理',
                shadeClose: false,
        ...
        function del(id) {
            layer.confirm('你确认要删除该销售经理吗？', function ()
            {
                // 确定
                $.ajax({
                    url: "<?php echo U('Admin/Index/delAuth'); ?>",
                    type: 'post',
                    data: {id: id},
                    success: function (v) {
                        layer.closeAll();
