<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:47:"./application/admin/view2/uploadify\upload.html";i:1539138094;}*/ ?>
...
<div class="W">
	...
	<div class="Wrap" id="Wrap">
		...
		<div class="Cont">
			<p class="Note">最多上传<strong><?php echo $info['num']; ?></strong>个附件,单文件最大<strong><?php echo $info['size1']; ?></strong>,类型<strong><?php echo $info['type']; ?></strong></p>
			<div class="flashWrap">
...
<script src="__ROOT__/public/plugins/uploadify/jquery.uploadify.js" type="text/javascript"></script>
...
<script type="text/javascript">
	...
	$('#uploadify').uploadify({
		...
		'progressData'    : 'all',
		'queueSizeLimit'  : '5',
		'uploadLimit'     : '<?php echo $info['num']; ?>',
		'fileSizeLimit'   : '<?php echo $info['size']; ?>',
...
$("#SaveBtn").click(function(){	
	...
	var num = <?php echo (isset($info['num']) && ($info['num'] !== '')?$info['num']:0); ?>;
	var fileurl_tmp = [];
