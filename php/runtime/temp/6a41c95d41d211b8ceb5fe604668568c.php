<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:42:"./application/admin/view2/index\index.html";i:1539771541;s:45:"./application/admin/view2/public\menubox.html";i:1539138094;s:42:"./application/admin/view2/public\left.html";i:1539138094;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="admincp-map ui-widget-content" tptype="map_nav" style="display:none;" id="draggable" >
  ...
  <div class="content"> 
	  ...
	  <li><a href="javascript:void(0);" data-param="map-shop">银行</a></li>
	  <li><a href="javascript:void(0);" data-param="map-mobile">模板</a></li>
	  <li><a href="javascript:void(0);" data-param="map-resource">插件</a></li>
	  </ul>
...
$(function(){
	...
	function ajaxFileUpload()
	{
		...
		(
			{
				url:'http://www.K11APP.cn/admin/index.php?act=common&op=pic_upload&type=admin_avatar&form_submit=ok&uploadpath=admin/avatar',
				secureuri:false,
				fileElementId:'_pic',
				dataType: 'json',
				...
				{
					if (data.status == 1){
						ajax_form('cutpic','裁剪','http://www.K11APP.cn/admin/index.php?act=common&op=pic_cut&type=admin_avatar&x=100&y=100&resize=1&ratio=1&url='+data.url,690);
					}else{
						alert(data.msg);
					}
...
function call_back(picname){
    $.getJSON('index.php?act=index&op=save_avatar&avatar=' + picname, function(data){
        if (data) {
            $('img[tptype="admin_avatar"]').attr('src', 'http://www.K11APP.cn/data/upload/admin/avatar/' + picname);
        }
    });
}
</script> 
...
<div class="admincp-header">
  ...
  <div class="nc-module-menu">
    <ul class="nc-row">
      <?php if(\think\Session::get('act_list') == 'all'): ?>
        <li>
          <a href="<?php echo U('Index/pubs'); ?>" target="_top" title="返回银行列表">
...
<script type="text/javascript">
    $('.login-out').click(function(){
      var url = "<?php echo U('Admin/logout'); ?>";
  ...
  function cleanCache(){
    var url = "<?php echo U('System/cleanCache'); ?>";
