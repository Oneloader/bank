<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view2/bank\sales_man.html";i:1540461041;s:44:"./application/admin/view2/public\layout.html";i:1539765626;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
            ...
            <div class="tDiv2" style="padding: 0px;">
                ...
                <div class="fbutton">
                    <a href="javascript:void(0)" onclick="addBank(0)">
                        <div class="add" title="新增销售经理">
                            <span><i class="fa fa-plus"></i>新增销售经理</span>
                        </div>
                    </a>
                </div>
            </div>
            <form action="<?php echo U('bank/sales_man'); ?>" id="search-form2" class="navbar-form form-inline" method="post">
                <div class="sDiv">
                    <div class="sDiv2">
                        <input type="text" size="30" name="key_word" class="qsbox" placeholder="经理姓名">
            ...
            <div class="hDivBox">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="center" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: center; width: 180px;" class="">销售手机号码</div>
                        </th>
                        <th align="center" abbr="ac_id" axis="col4" class="">
                            <div style="text-align: center; width: 180px;" class="">所属支行名称</div>
                        </th>
                ...
                <table>
                    ...
                    <?php if(!(empty($lists) || (($lists instanceof \think\Collection || $lists instanceof \think\Paginator ) && $lists->isEmpty()))): if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td align="center" class="">
                                    <div style="text-align: center; width: 180px;"><?php echo $list['phone']; ?></div>
                                </td>
                                <td align="center" class="">
    ...
    <script>
        function addBank(id){
            var url = "<?php echo U('Admin/Bank/addEditSalesMan'); ?>?id="+id;
            layer.open({
                type: 2,
                title: '添加/编辑销售经理',
                shadeClose: true,
        ...
        function del(id) {
            layer.confirm('你确认要删除该销售经理吗？', function ()
            {
                // 确定
                $.ajax({
                    url: "<?php echo U('Admin/Bank/sales_man_del'); ?>",
                    type: 'post',
                    data: {id: id},
                    success: function (v) {
                        layer.closeAll();
