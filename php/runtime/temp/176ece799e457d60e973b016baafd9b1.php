<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:42:"./application/admin/view2/admin\login.html";i:1539847630;}*/ ?>
<!doctype html>
...
if(!$.cookie('K11APPActionParam') && $.cookie('admin_type') != 1){
        ...
        $(function(){
            ...
            $('#theForm input[name=submit]').on('click',function(){
                ...
                if(vertify && $('#theForm input[name=username]').val() != '' && $('#theForm input[name=password]').val() != ''){
                    $.ajax({
                        async:false,
                        url:"<?php echo U('Admin/Admin/login',array('t'=>mt_rand())); ?>",
